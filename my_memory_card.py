...
from PyQt5.QtWidgets import (#ЗДЕСЬ БЫЛ ЗЫКОВ
        QApplication, QWidget, 
        QHBoxLayout, QVBoxLayout, #ЗДЕСЬ БЫЛ ЗЫКОВ
        QGroupBox, QButtonGroup, QRadioButton,  
        QPushButton, QLabel)
from random import randint, shuffle #ЗДЕСЬ БЫЛ ЗЫКОВ


class Question():#ЗДЕСЬ БЫЛ ЗЫКОВ
    ''' содержит вопрос, правильный ответ и три неправильных'''
    def __init__(self, question, right_answer, wrong1, wrong2, wrong3):
        self.question = question
        self.right_answer = right_answer
        self.wrong1 = wrong1
        self.wrong2 = wrong2#ЗДЕСЬ БЫЛ ЗЫКОВ
        self.wrong3 = wrong3


questions_list = [] #ЗДЕСЬ БЫЛ ЗЫКОВ
questions_list.append(#ЗДЕСЬ БЫЛ ЗЫКОВ
...
app = QApplication([])
#ЗДЕСЬ БЫЛ ЗЫКОВ#ЗДЕСЬ БЫЛ ЗЫКОВ
...
rbtn_4 = QRadioButton('Вариант 4')#ЗДЕСЬ БЫЛ ЗЫКОВ
...
layout_ans2.addWidget(rbtn_2)#ЗДЕСЬ БЫЛ ЗЫКОВ
